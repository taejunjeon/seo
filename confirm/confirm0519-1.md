...
기준일: 2026-05-19
문서 성격: 프론트엔드 화면 확인용 컨펌 / 운영 배포 전 승인 큐
대상 화면: `/ads/meta-utm`
Lane: Green local development + frontend confirmation / 운영 배포는 Yellow 별도 승인
...
TJ님이 확인할 것은 화면 구성이 Meta UI와 비교해 충분히 익숙한지, 광고 썸네일과 게재 상태/ID/성과 지표가 의사결정에 충분한지다. 운영 배포는 이 컨펌 이후 별도 승인으로 진행한다.
