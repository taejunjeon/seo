작성 시각: 2026-05-26 20:50 KST
기준일: 2026-05-26
문서 성격: 바이오컴 아임웹 푸터 코드 전체 교체안 — Meta paidTouchBeforeCheckout payload 병합 no-publish 초안
...
harness_preflight:
  ...
  source_window_freshness_confidence:
    ...
    site: biocom
    freshness: 2026-05-26 20:50 KST local draft
...
바뀐 부분은 푸터 Block 3의 결제완료 전송 payload다. GTM 저장 태그가 남긴 `paidTouchBeforeCheckout` 값을 결제완료 payload의 `metadata` 안에 같이 싣는다.
...
- 변경: 결제 전에 저장된 유료 유입 snapshot을 `metadata.paidTouchBeforeCheckout`로 같이 보낸다.
- 기대효과: 숫자 Meta campaign/adset/ad ID가 결제완료 row까지 이어져 A급 매칭 재료가 늘어난다.
...
/* ── Block 3: payment_page_seen / payment_success split v4.4.4 ──
   Purpose:
   ...
   Version: 2026-05-26-biocom-payment-split-v4-4-4
*/
(function () {
  'use strict';
  ...
  var CONFIG = {
    ...
    */
    ...
    snippetVersion: '2026-05-26-biocom-payment-split-v4-4-4',
    pageSeenVersion: '2026-05-21-biocom-payment-page-seen-v4-4-3',
    paymentSuccessVersion: '2026-05-26-biocom-payment-success-v4-4-4',
    googleClickIdGuardVersion: 'v4.4.3',
