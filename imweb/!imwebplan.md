...
| 6 | TJ | 리드 상태값과 운영 처리 규칙을 승인한다 | 무엇: 신규, 연락시도, 연락완료, 예약완료, 방문완료, 결제완료, 노쇼, 불량/중복의 이름과 의미를 확정한다. 왜: 상태 정의가 흔들리면 주간 퍼널과 상담원 처리율을 믿을 수 없다. 어떻게: 실제 상담원이 쓰는 표현과 맞지 않는 상태를 알려주고, 필요한 상태 추가/삭제를 승인한다. 산출물/검증: 운영 기준 상태값 v1 확정. 의존성: 부분병렬. |
...
| Phase2 | [[#Phase2-Sprint3]] | 공개 홈페이지/랜딩 자체화 | Codex + Claude Code | 60% / 0% | [[#Phase2-Sprint3\|이동]] |
| Phase3 | [[#Phase3-Sprint4]] | 폼/예약/리드 원장 | Codex + Claude Code | 78% / 0% | [[#Phase3-Sprint4\|이동]] |
