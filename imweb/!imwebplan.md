...
AIBIO는 아임웹 관리자 전체를 복제할 필요가 없다. 2026-04-26 12:26 KST 기준 1순위는 홈페이지 전체 완성이 아니라 `자체 리드/예약 원장`이다. 공개 폼은 로컬 SQLite 원장 저장까지 연결했고, `/shop_view?idx=25` 성격의 첫 실험 랜딩도 자체 route로 만들었다. 운영 기준은 아직 0%다. 이유는 운영 배포, 권한, 실제 상담원 사용, 아임웹 30일 병행 대조가 아직 남아 있기 때문이다.
...
| Phase2 | [[#Phase2-Sprint3]] | 공개 홈페이지/랜딩 자체화 | Codex + Claude Code | 55% / 0% | [[#Phase2-Sprint3\|이동]] |
