...
Next document: [[path-b-limited-deploy-approval-20260508]]
...
2. `backend/src/routes/attribution.ts`
   ...
   - body 16KB 초과는 413 `payload_too_large`로 차단.
...
2026-05-08 23:23 KST 보강: 제한 deploy 승인안은 [[path-b-limited-deploy-approval-20260508]]에 별도 작성했다.
