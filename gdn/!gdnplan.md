...
5. 다음은 [[paid-click-intent-gtm-preview-approval-20260506]] 기준 GTM Preview 실행 여부 판단이다. 목표는 랜딩/체크아웃 시점 `gclid/gbraid/wbraid`가 storage와 no-send receiver까지 이어지는지 보는 것이다. 이 단계도 실제 platform send는 0건이어야 한다.
6. 위 2~5번이 통과한 뒤에만 Google Ads confirmed purchase Red Lane 실행 여부를 다시 판단한다.
