...
다음 실행은 Google Ads 전송이 아니라 GTM Production publish 승인 판단이다. 승인안은 [[paid-click-intent-gtm-production-publish-approval-20260506]]에 있다.
...
9. 다음은 Google Ads confirmed purchase Red Lane 실행이 아니라, TJ님이 `paid_click_intent v1` 운영 GTM publish 여부를 판단하는 것이다.
