...
다음 실행은 Google Ads 전송이 아니라 Google Ads landing-session 기준 click id 분모 분석과 GTM Production publish 승인안 작성이다.
...
| Phase4 | [[#Phase4-Sprint6]] | 전환 오염 제거와 보정 | TJ + Codex + Claude Code | 42% / 0% | [[#Phase4-Sprint6\|이동]] |
...
7. 다음은 Google Ads confirmed purchase Red Lane 실행이 아니라, 운영 GTM publish 승인안과 Google Ads landing-session 기준 click id 분모 분석이다.
