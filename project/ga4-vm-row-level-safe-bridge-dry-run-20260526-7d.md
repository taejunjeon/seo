...
- 바이오컴은 구매 세션과 이탈 세션이 최소 87.17% 이상 GA4와 이어졌다. 기존 30%대 연결률은 BigQuery 결과를 2만 row까지만 읽던 dry-run 구현 제한 영향이었다.
- 더클린커피는 구매 세션과 이탈 세션이 최소 88.18% 이상 GA4와 이어져 row-level 행동 비교가 가능하다.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| biocom | confirmed_purchase | 402 | 353 | 87.81% | 117478734 | 205.94 | 343.46 | 90.93% | 14.16% | 99.15% | 4.25% | 99.72% |
| biocom | dropped_checkout | 686 | 598 | 87.17% | 0 | 101.45 | 233.99 | 72.58% | 10.87% | 52.51% | 3.34% | 4.35% |
| thecleancoffee | confirmed_purchase | 115 | 104 | 90.43% | 6281853 | 213.28 | 375.77 | 100% | 29.81% | 100% | 0% | 100% |
| thecleancoffee | dropped_checkout | 203 | 179 | 88.18% | 0 | 150.69 | 339.22 | 89.94% | 16.76% | 67.04% | 0% | 23.46% |
