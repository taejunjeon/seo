...
1. `meta_biocom_iiari_260518`와 `meta_biocom_iiari_260518 - 사본`이 동시에 보였던 이유는 단순 복제 실수라기보다 소재 구분이다.
   - `meta_biocom_iiari_260518 - 종대사`
     - 이전 표시: `meta_biocom_iiari_260518 - 사본`
     - 소재: 종합대사기능분석 서비스(종대사)
     - 라이브 광고: `meta_biocom_iiari_acid_260518`
     - adset ID: `120245956430970396`
   - `meta_biocom_iiari_260518`
     - 소재: 음식물과민증분석 서비스(음과검)
     - 라이브 광고: `meta_biocom_iiari_Igg_260518`
     - adset ID: `120245700952890396`

2. 이 회신으로 바뀌는 판정은 아래와 같다.
   - A급 숫자 ID row는 광고세트 단위까지 해석할 수 있다.
   - adset ID `120245956430970396`은 종대사 소재, adset ID `120245700952890396`은 음과검 소재로 읽는다.
   - D급 16건은 여전히 숫자 ID가 없으므로 자동 배정 금지 상태를 유지한다.
   - 이아리 공구는 2026-05-26 종료 예정이므로, 2차 활용 광고가 생기면 신규 광고부터 고유 alias와 숫자 ID URL Parameters를 확인한다.
