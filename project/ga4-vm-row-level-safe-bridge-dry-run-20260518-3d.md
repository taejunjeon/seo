...
- 바이오컴은 구매 세션과 이탈 세션이 최소 67.58% 이상 GA4와 이어졌다. 기존 30%대 연결률은 BigQuery 결과를 2만 row까지만 읽던 dry-run 구현 제한 영향이었다.
- 더클린커피는 구매 세션과 이탈 세션이 최소 75.89% 이상 GA4와 이어져 row-level 행동 비교가 가능하다.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| biocom | confirmed_purchase | 210 | 160 | 76.19% | 65472566 | 205.95 | 425.1 | 92.5% | 18.75% | 98.75% | 3.75% | 99.38% |
| biocom | dropped_checkout | 330 | 223 | 67.58% | 0 | 112.19 | 226.07 | 72.2% | 11.66% | 54.26% | 4.04% | 5.38% |
| thecleancoffee | confirmed_purchase | 102 | 80 | 78.43% | 7081032 | 283.47 | 518.3 | 100% | 28.75% | 0% | 0% | 100% |
| thecleancoffee | dropped_checkout | 112 | 85 | 75.89% | 0 | 159.37 | 282.32 | 94.12% | 15.29% | 0% | 0% | 16.47% |

## 판단

| site | readiness | interpretation |
|---|---|---|
| biocom | partial_bridge_usable_with_caveat | 구매자 쪽은 충분하지만 이탈자 쪽은 누락 가능성을 함께 표시해야 한다. |
| thecleancoffee | partial_bridge_usable_with_caveat | 구매자 쪽은 충분하지만 이탈자 쪽은 누락 가능성을 함께 표시해야 한다. |
