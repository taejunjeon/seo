...
현재 판단: 지금은 보내지 않습니다. 실제 결제완료 주문에 Google click id와 주문 payload가 안전하게 붙는 후보가 부족하고, conversion action/업로드 승인도 열지 않았습니다.

## no-send 후보 판정

| 기준 | 실제 결제완료 | 매출 | click id 직접 보존 | 보존률 | 전송 후보 | 주요 차단 이유 |
| --- | --- | --- | --- | --- | --- | --- |
| 최근 7일 | 466 | 113,553,495 | 5 | 1.07% | 0 | read_only_phase 466, approval_required 466, google_ads_conversion_action_not_created_or_selected 466, conversion_upload_not_approved 466 |
| 최근 30일 | 2,234 | 518,916,615 | 16 | 0.72% | 0 | read_only_phase 2234, approval_required 2234, google_ads_conversion_action_not_created_or_selected 2234, conversion_upload_not_approved 2234 |
| 5월 21일 21:15 보강 이후 | 114 | n/a | 0 | 0.00% | 0 | read_only_phase 114, approval_required 114, google_ads_conversion_action_not_created_or_selected 114, conversion_upload_not_approved 114 |
...
| 실제 결제완료 | 같은 기간 confirmed payment_success 114건 중 직접 Google click id 보존은 0건입니다. live 최근 7일 전체로 넓히면 466건 중 5건만 직접 보존입니다. | 결제완료 주문에 붙는 최종 evidence가 부족합니다. Google Ads upload 후보로 올릴 수 없습니다. |
