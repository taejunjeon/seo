...
- 바이오컴은 구매 세션과 이탈 세션이 최소 86.23% 이상 GA4와 이어졌다. 기존 30%대 연결률은 BigQuery 결과를 2만 row까지만 읽던 dry-run 구현 제한 영향이었다.
- 더클린커피는 구매 세션과 이탈 세션이 최소 93.04% 이상 GA4와 이어져 row-level 행동 비교가 가능하다.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| biocom | confirmed_purchase | 406 | 361 | 88.92% | 116238925 | 240.52 | 426.51 | 91.69% | 19.39% | 98.61% | 7.2% | 97.78% |
| biocom | dropped_checkout | 770 | 664 | 86.23% | 0 | 126.93 | 253.52 | 74.4% | 10.84% | 60.24% | 4.07% | 9.64% |
| thecleancoffee | confirmed_purchase | 348 | 329 | 94.54% | 23000341 | 253.81 | 429.57 | 99.7% | 23.1% | 0% | 0% | 99.09% |
| thecleancoffee | dropped_checkout | 388 | 361 | 93.04% | 0 | 157.15 | 282.32 | 89.47% | 14.96% | 0% | 0% | 17.17% |
