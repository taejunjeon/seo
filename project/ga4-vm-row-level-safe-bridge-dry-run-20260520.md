...
- 바이오컴은 구매 세션과 이탈 세션이 최소 76.29% 이상 GA4와 이어졌다. 기존 30%대 연결률은 BigQuery 결과를 2만 row까지만 읽던 dry-run 구현 제한 영향이었다.
- 더클린커피는 구매 세션과 이탈 세션이 최소 85.46% 이상 GA4와 이어져 row-level 행동 비교가 가능하다.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| biocom | confirmed_purchase | 411 | 346 | 84.18% | 122833969 | 218.8 | 424.97 | 91.33% | 17.63% | 99.13% | 4.62% | 98.84% |
| biocom | dropped_checkout | 835 | 637 | 76.29% | 0 | 121.18 | 245.89 | 74.73% | 10.05% | 54.47% | 2.83% | 9.58% |
| thecleancoffee | confirmed_purchase | 227 | 209 | 92.07% | 14663148 | 265.94 | 441.17 | 99.52% | 27.75% | 10.05% | 0% | 98.56% |
| thecleancoffee | dropped_checkout | 282 | 241 | 85.46% | 0 | 147.61 | 276.11 | 90.46% | 15.77% | 8.3% | 0% | 18.26% |
