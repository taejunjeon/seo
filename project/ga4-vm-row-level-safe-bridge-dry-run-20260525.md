...
- 바이오컴은 구매 세션과 이탈 세션이 최소 84.25% 이상 GA4와 이어졌다. 기존 30%대 연결률은 BigQuery 결과를 2만 row까지만 읽던 dry-run 구현 제한 영향이었다.
- 더클린커피는 구매 세션과 이탈 세션이 최소 86.61% 이상 GA4와 이어져 row-level 행동 비교가 가능하다.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| biocom | confirmed_purchase | 400 | 337 | 84.25% | 119656205 | 205.94 | 353.9 | 90.8% | 13.65% | 98.52% | 4.15% | 99.11% |
| biocom | dropped_checkout | 721 | 646 | 89.6% | 0 | 93.4 | 224.04 | 71.98% | 9.6% | 46.59% | 2.79% | 3.56% |
| thecleancoffee | confirmed_purchase | 127 | 110 | 86.61% | 7672388 | 208.99 | 398.41 | 100% | 30.91% | 100% | 0% | 100% |
| thecleancoffee | dropped_checkout | 203 | 176 | 86.7% | 0 | 125.07 | 335.37 | 90.34% | 17.61% | 67.61% | 0% | 20.45% |
