...
- VM Cloud에서 Meta 유입으로 분류된 바이오컴 safe session은 251건이고, 이 중 GA4와 붙은 것은 232건(92.43%)이다.
- Meta 구매자는 137건, 비결제자는 114건이다.
- GA4로 붙은 row 기준 구매자 p50 체류시간은 214.06s, 비결제자는 196.57s로 차이는 17.49s이다.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 구매자 | 137 | 127 | 92.7% | ₩48,222,491 | 214.06s | 363.92s | 96.85% | 45.67% | 14.96% | 99.21% | 0.79% | 98.43% |
| 비결제자 | 114 | 105 | 92.11% | ₩0 | 196.57s | 298.67s | 84.76% | 57.14% | 15.24% | 93.33% | 2.86% | 17.14% |

## 차이값

- 체류시간: 구매자 - 비결제자 = 17.49s.
- scroll90: 구매자 - 비결제자 = 12.09%.
- view_item: 구매자 - 비결제자 = -11.47%.
- cart/view_cart: 구매자 - 비결제자 = -0.28%.
