...
| 5 | [[coffee/!imwebcoffee_code_latest_0501\|더클린커피 imweb 헤더/푸터 코드 정본]] | tracking/wrapper/intent/eid 작업 전 imweb 안 4 layer (server payment decision guard v3, checkout-started v1, payment-success-order-code v1, funnel-capi v3) 의 실제 소스 확인. MIRROR_EVENTS 목록, sessionId 키 `__seo_funnel_session`, eid 형식, server CAPI endpoint 모두 여기에 있음 |
| 6 | [[harness/coffee-data/LIVE_TAG_INVENTORY|Coffee Live Tag Inventory]] | tracking 작업 직전 §1~§8 항목 채움 (snapshot 7일 stale 시 hard fail) |
| 7 | [[data/coffee-ga4-baseline-20260501|GA4 BigQuery 기준선]] | GA4 purchase 기준선 확인 |
| 8 | [[data/coffee-imweb-operational-readonly-20260501|Imweb/GA4 NPay Read-only 리포트]] | NPay actual vs GA4 NPay형 분해 |
| 9 | [[data/coffee-npay-unassigned-ga4-guard-20260501|NPay unassigned GA4 Guard]] | 남은 actual 18건의 robust guard 결과 |
| 10 | [[data/coffee-excel-import-dry-run-20260501|엑셀 Import Dry-run]] | 2024/2025 엑셀 join 가능성 |
| 11 | [[data/coffee-dry-run-schema|Coffee Dry-run Schema]] | report row schema |
| 12 | [[data/!data_inventory|데이터 위치 인벤토리]] | 파일 경로와 stale 여부 |
