...
3. read-only script 또는 쿼리를 실행한다.
4. 산출물을 `data/coffee-*.md`에 저장한다.
5. [[harness/coffee-data/VERIFY|VERIFY]]를 실행한다.
6. [[harness/coffee-data/AUDITOR_CHECKLIST|AUDITOR_CHECKLIST]]로 verdict를 낸다.
7. 새 예외는 [[harness/coffee-data/LESSONS|LESSONS]]에 남긴다.
8. `data/!coffeedata.md`의 다음 할일과 Phase/Sprint 숫자를 갱신한다.
