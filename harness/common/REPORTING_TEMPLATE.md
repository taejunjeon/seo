# Growth Data Agent Reporting Template v1.4.1

작성 시각: 2026-05-02 23:12 KST
최근 업데이트: 2026-05-27 KST (프로젝트 OKR/액션플랜/진척률 상시 출력 / Green 자율 다음 할일 / Codex 숲 관점 후속 진행 메시지 추가)
목적: 작업 완료 보고, 승인 요청, Auditor verdict의 공통 형식
상태: 공통 하네스 기준판

## v1.4 변경 (2026-05-27)

### 프로젝트 OKR / 액션플랜 / 진척률 상시 출력

- 결과보고 텍스트 출력에는 프로젝트 본연의 `Objective`, `Key Results`, `액션플랜`, `액션플랜별 진척률 %`, `이번 작업이 OKR에 준 영향`을 항상 넣는다.
- 작업 단위가 작더라도 국소 완료 여부만 쓰지 않고, 전체 프로젝트 목표와 액션플랜에서 이번 작업의 위치를 적는다.
- 진척률 숫자가 추정이면 `약`을 붙이고, 무엇을 끝내면 몇 %가 올라가는지 함께 적는다.

### Green 자율 다음 할일 구상

- 다음 할일은 지금 고친 파일이나 국소 이슈만 보지 않는다.
- 하네스 Green 영역 안에서 목표 달성을 위해 필요한 조사, 설계, 문서화, 검증, 로컬 구현은 Codex가 자율적으로 진행한다는 가정 하에 다음 할일을 구상한다.
- `Codex가 할 일`에는 목표 달성을 위해 나무 가지가 아닌 숲을 보고, 충분히 밀고 나갈 수 있는 부분을 구체적인 추진 단위로 제시한다.
- `Codex가 할 일`에는 다음 문장을 그대로 포함한다: `추가로 목표 달성을 위해 본 할일이 마무리 된 뒤, 얻게되는 새로운 인사이트로 추가적인 조사나 설계, 제안이 필요하면 하네스 그린 영역 안에서 진행하겠습니다.`
- 단, 운영 배포, 운영DB write, 외부 전송, 광고 예산/캠페인 변경처럼 Yellow/Red 중단선을 넘는 일은 승인 항목으로 분리한다.
...
- 추천 이유:
- 추천 방향에 대한 자신감:
- Codex가 목표 달성을 위해 숲을 보고 충분히 밀고 나갈 Green 작업을 제시했는가:
- Codex 할 일에 정해진 Green 후속 진행 메시지를 포함했는가:
...
- 다음 할일은 국소적으로만 보지 말고, 프로젝트 본연의 OKR과 액션플랜 달성 관점에서 구상한다.
- 하네스 Green 영역 안에서 목표 달성을 위해 필요한 조사, 설계, 문서화, 검증, 로컬 구현은 Codex가 자율적으로 진행한다는 가정 하에 다음 할일에 포함한다.
- `Codex가 할 일`에는 나무 가지가 아닌 숲을 보고, 충분히 밀고 나갈 수 있는 조사/설계/제안/검증/로컬 구현을 구체적인 추진 단위로 제시한다.
- `Codex가 할 일`에는 다음 문장을 그대로 포함한다: `추가로 목표 달성을 위해 본 할일이 마무리 된 뒤, 얻게되는 새로운 인사이트로 추가적인 조사나 설계, 제안이 필요하면 하네스 그린 영역 안에서 진행하겠습니다.`
