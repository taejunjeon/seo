...
최종 업데이트: 2026-05-08 23:27 KST
기준일: 2026-05-08
상태: active canonical
Owner: total / attribution
Supersedes: [[!total_past|기존 Phase 순서 정본]]
Next document: [[../gdn/path-b-limited-deploy-approval-20260508]] Path B 제한 deploy 승인안 / [[../gdn/path-b-gtm-preview-final-checklist-20260508]] GTM Preview final checklist / [[../gdn/path-b-order-bridge-reliability-dry-run-design-20260508]] reliability dry-run 설계 / [[../gdn/canary-capture-health-24h-20260508]] 24h 수집 건강검진 결과
...
|   2 | [[#Phase4-Sprint6]] | path_b_yellow_packet_ready | Codex + TJ | Path B email/phone hash-only 제한 deploy 또는 tunnel smoke와 GTM Preview 실행 여부를 판단한다 | Path C member_code source가 없어 회원/비회원 주문을 잇는 다음 결정적 연결키가 필요하다 | [[../gdn/path-b-limited-deploy-approval-20260508]], [[../gdn/path-b-gtm-preview-final-checklist-20260508]], [[../gdn/path-b-order-bridge-reliability-dry-run-design-20260508]] 기준으로 raw 저장 없이 hash-only smoke와 Preview를 준비한다 | 로컬 endpoint/fixture는 완료. 실행은 backend 제한 deploy 또는 tunnel smoke + GTM Preview 승인 필요 | [[#Phase4-Sprint6]] / [[../gdn/path-b-limited-deploy-approval-20260508]] | YES, 제한 deploy 또는 tunnel + Preview |
...
| P0 | path_b_yellow_packet_ready | Phase4-Sprint6 | wrapper Preview + Path B fallback bridge | member_code source가 없어 회원/비회원 주문을 잇는 hash-only bridge가 필요하다 | 비로그인 safety PASS. 로그인 NPay 클릭 200/201/203과 source 재탐색 모두 usable source 없음. Path B no-send HMAC endpoint 로컬 초안, fixture 5 PASS, 제한 deploy 승인안, GTM Preview final checklist, reliability dry-run 설계 작성. 운영 deploy/Production publish HOLD | Codex | YES 완료, 실행은 별도 Yellow | [[../gdn/path-b-limited-deploy-approval-20260508]] |
