...
현재 전체 완성도는 약 **68%**다. Path B 주문완료 bridge와 NPay status guard는 많이 닫혔지만, 운영DB `PAYMENT_COMPLETE` 기반 confirmed-only 후보 재계산, Google Ads upload 전 no-send 검증, Red 승인 패킷은 아직 남아 있다.
