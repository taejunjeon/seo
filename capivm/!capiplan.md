...
harness_preflight:
  ...
  source_window_freshness_confidence:
    source: "VM Cloud attribution ledger + Meta CAPI send log + funnel-health/roas-summary live contract + local backend metaCapi guard test + GTM export audit + Meta UI 캡처/사용자 관측 + capivm/!capiplan.md"
    window: "2026-05-14 ~ 2026-05-17 KST incident/recovery window, 최근 7일 ROAS/퍼널 문서 기준"
    freshness: "문서 정리 시각 2026-05-17 14:38 KST. Phase2-Sprint5 AddPaymentInfo source gap은 VM Cloud funnel-health cache 2026-05-17 14:34 KST와 GTM export 2026-05-16 기준"
    confidence: 0.9
```
...
다음 행동은 이 문서의 KR 기준으로 `누락 큐`, `중간 전환 CAPI 후보`, `환불/취소 guard`, `Events Manager UI 검증`, `Test Events smoke`를 순서대로 닫는 것이다.
