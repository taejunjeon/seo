          ...
          <div style={{ display: "grid", gap: 20 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
              {[
                ...
                { href: "/coffeevip", title: "더클린커피 VIP 전략", desc: "5단계 VIP 티어 · 바이오컴 세계관 진입 · AIBIO 크로스셀 특전 설계", icon: "👑" },
                { href: "/coupon", title: "쿠폰 CRM 분석", desc: "쿠폰 발급/사용률, ROI 분석, 할인 최적화 전략", icon: "🎟" },
                { href: "/coupang", title: "쿠팡 매출 대시보드", desc: "BIOCOM/TEAMKETO 월별 매출, 더클린커피 사업부 이관 시점, Top 상품, 수수료율 추이", icon: "📦" },
                { href: "/crm?tab=messaging", title: "알림톡 발송", desc: "카카오 알림톡 발송, 템플릿 선택, 테스트/실발송, 이력 확인", icon: "💬" },
                { href: "/aibio-funnel", title: "AIBIO 광고 퍼널", desc: "리커버리랩 Meta 캠페인 판단, 폼 제출 Lead, 채널톡, CRM 방문 지표 연결 설계", icon: "🧬" },
                ...
                { href: "/ads/google-roas-report", title: "Google ROAS 정합성 보고서", desc: "KR 현재%, 액션플랜, 내부 결제완료 ROAS, NPay actual 보정을 한 화면에서 예산 판단", icon: "G" },
