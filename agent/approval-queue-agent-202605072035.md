...
| run_id | approval-queue-agent-202605072035 |
| mode | approval_index |
| window | 20260507 |
...
| agent_json | /Users/vibetj/coding/seo/data/approval-queue-agent-202605072035.json |
| agent_markdown | /Users/vibetj/coding/seo/agent/approval-queue-agent-202605072035.md |
...
```json
{
  ...
  "future_approvals": [
    {
      "file": "confirm/!confirm.md",
      "status": "future",
      "title": "TJ 승인 큐",
      "reason": "외부 플랫폼 숫자, 운영 배포, 또는 write 가능성이 있어 미래 승인",
      "resume_condition": "별도 승인 문서의 재개 조건 충족 후"
    },
    {
    ...
    {
      "file": "total/!total-current.md",
      "status": "future",
      "title": "월별 유입 채널 매출 정합성 현재 정본",
      "reason": "외부 플랫폼 숫자, 운영 배포, 또는 write 가능성이 있어 미래 승인",
      "resume_condition": "별도 승인 문서의 재개 조건 충족 후"
    }
  ],
