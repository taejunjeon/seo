...
| 18 | VM 배포 sprint | 가능 상태 | Codex + TJ | A-3 GTM Preview dispatcher 재개 | 항목 15~17 PASS 완료 → [[coffee-npay-intent-a3-gtm-preview-dispatcher-runbook-20260502]] 의 Step S1~T4 재진입 가능 | smoke window + GTM Preview + chrome NPay click 1~2회 + dispatcher state 캡처 + Codex backend polling | [[coffee-npay-intent-a3-gtm-preview-dispatcher-runbook-20260502]] | YES, A-3 재진입 승인 별도 |
