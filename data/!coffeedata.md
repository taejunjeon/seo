...
| 19 | dispatcher v2.1 sprint | 대기 | Codex + TJ | dispatcher v2.1 개선 — A-4 publish 선결 조건 | TJ 결정 (2026-05-02): A-4 Production publish 전 dispatcher v2.1 개선이 선결. 특히 imweb_order_code 가 deterministic join 핵심 키이므로 site dispatcher row 의 null 은 publish 전에 보강해야 한다 | 우선순위: ① O2 imweb_order_code null 보강 (retry capture or delayed dispatch — 핵심) ② O1 race condition 보강 (in-flight Set 추가) ③ O3 payment_button_type null 보강 (payload/validation 정리). A-4 진입 시점에 통합 단일 문서 (예: `coffee-a4-publish-decision-and-dispatcher-improvements-*.md`) 신규 작성 | [[coffee-npay-intent-a3-gtm-preview-dispatcher-runbook-20260502#a-3-v2-pass-2026-05-02-kst]] | YES, 각 개선 sprint 진입 시 별도 승인 |
| 20 | A-4 publish 결정 sprint | 보류 | TJ + Codex | A-4 GTM Production publish 결정 — dispatcher v2.1 PASS 후 진입 | 항목 19 의 O2 (필수) + O1/O3 (권장) 모두 PASS 한 후 publish 결정. 이전 까지는 보류 | A-3 v2 evidence + dispatcher v2.1 PASS evidence 결합 + runbook 의 "다음 phase" 표 (A-4/A-5/A-6) + enforce approval v1.6 의 7일 모니터링 지표 + 11 stop condition 검토 | [[coffee-npay-intent-a3-gtm-preview-dispatcher-runbook-20260502#다음-phase-a-3-pass-후-tj-별도-승인]] / [[coffee-npay-intent-ledger-enforce-approval-20260501]] | YES, publish 명시 승인 별도 |
