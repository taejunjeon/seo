# biocom BigQuery Link 자동 확인 - 20260513-total-doc-check

작성 시각: 2026-05-13 23:02:55 KST
작업 성격: Green Lane, cron scheduled read-only check
관련 JSON: `biocom-bigquery-link-postcheck-20260513-total-doc-check.json`

## 10초 요약

자동 확인 결과는 `new_export_daily_table_available`이다.
...
harness_preflight:
  ...
  source_window_freshness_confidence:
    ...
    freshness: 2026-05-13 23:02:55 KST
    site: biocom
    confidence: A-
```
...
- project-dadba7dd-0229-4ff6-81c.analytics_304759974: exists, location asia-northeast3, latest events_20260512, tables 6, rows 284,879
- hurdlers-naver-pay.analytics_304759974: exists, location asia-northeast3, latest events_20260506, tables 605, rows 24,495,738
- project-dadba7dd-0229-4ff6-81c.analytics_304759974_hurdlers_backfill: exists, location asia-northeast3, latest events_20260506, tables 605, rows 24,495,738

## New Export Latest Sanity

| table | rows | purchase | distinct transaction_id | max event time KST |
|---|---:|---:|---:|---|
| `events_20260512` | 49,111 | 64 | 64 | 2026-05-12 23:59:57 UTC+9 |
