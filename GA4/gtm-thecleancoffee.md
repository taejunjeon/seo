...
| GTM container | GTM-5M33GC4 / live version 21 (AGENTSOS GA4 begin_checkout rename - 2026-05-18) |
...
| 51 | active | html | HURDLERS - [데이터레이어] 주문서작성 | Custom HTML | 브라우저 실행 스크립트 | HURDLE - [DOM 사용 가능] 주문서작성 | - | dataLayer push 후보 |
...
5. 주문서 작성/결제 시작
   ...
   - 성공 기준: GTM 설정상 존재하는 `AGENTSOS - [GA4 이벤트전송] begin_checkout`이 실제 주문서 화면에서 Fired.
