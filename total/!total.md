...
| [[../gdn/paid-click-intent-gtm-preview-approval-20260506|paid_click_intent GTM Preview 승인안]] | Yellow Lane Preview only 승인안 | pending approval | 현재 GTM live latest version 재확인 후 fresh workspace Preview | Preview 결과 보고서 작성 후 close |
...
| 32 | [[#Phase4-Sprint6]] | 승인안 작성 완료 / 실행 대기 | TJ+Codex | paid_click_intent GTM Preview 승인안을 만들었다 | Google click id를 실제 전송 전에 Preview로만 보존 검증해야 한다 | [[../gdn/paid-click-intent-gtm-preview-approval-20260506]]에 현재 live latest version 재확인, fresh workspace, 테스트 URL, 별도 no-send endpoint, TEST click id live 차단, 성공/실패 기준을 기록했다 | [[#Phase4-Sprint6]] / [[../gdn/paid-click-intent-gtm-preview-approval-20260506]] | Preview 실행은 YES |
...
- [ ] paid_click_intent GTM Preview 실행 여부를 TJ님이 판단한다. 무엇: 운영 publish 전에 `gclid/gbraid/wbraid`가 랜딩에서 storage와 `POST /api/attribution/paid-click-intent/no-send`까지 이어지는지 Preview로만 본다. 왜: 623건 중 5건만 Google click id가 남아 있어 Google Ads confirmed purchase의 1차 병목이다. 어떻게: [[../gdn/paid-click-intent-gtm-preview-approval-20260506]] 기준으로 현재 GTM live latest version을 재확인하고 fresh workspace에서 Preview만 실행한다. 산출물: Preview 결과 캡처와 no-send receiver 응답. 검증: 실제 platform send/write/publish 0건, `TEST_` click id live 후보 차단.
