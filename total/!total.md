...
| 30 | [[#Phase4-Sprint6]] | 우리 기준 완료 / 운영 실행 대기 | Codex | confirmed_purchase no-send 수신·디스패처 계약을 만들었다 | 앞으로는 NPay 실제 결제완료와 홈페이지 결제완료만 purchase 후보로 만들고 click/count/payment start는 제외해야 한다 | `POST /api/attribution/confirmed-purchase/no-send` preview route와 [[../gdn/confirmed-purchase-no-send-pipeline-contract-20260505]]를 추가했다 | [[#Phase4-Sprint6]] / [[../gdn/confirmed-purchase-no-send-pipeline-contract-20260505]] | 실제 전송은 YES |
...
| 32 | [[#Phase4-Sprint6]] | 승인안 작성 완료 / 실행 대기 | TJ+Codex | paid_click_intent GTM Preview 승인안을 만들었다 | Google click id를 실제 전송 전에 Preview로만 보존 검증해야 한다 | [[../gdn/paid-click-intent-gtm-preview-approval-20260506]]에 fresh workspace, 테스트 URL, 성공/실패 기준, 금지선을 기록했다 | [[#Phase4-Sprint6]] / [[../gdn/paid-click-intent-gtm-preview-approval-20260506]] | Preview 실행은 YES |
| 33 | [[#Phase2-Sprint4]] | 우리 기준 완료 | Codex | NPay rail source 공백을 분리했다 | publish 이전 NPay 주문을 unmatched로 오해하면 안 된다 | [[../naver/npay-rail-source-gap-20260506]]에 2026년 4월 NPay 139건 중 publish 이전 126건 / 20,983,200원을 `source_unavailable_before_publish`로 기록했다 | [[#Phase2-Sprint4]] / [[../naver/npay-rail-source-gap-20260506]] | NO |
...
- [ ] paid_click_intent GTM Preview 실행 여부를 TJ님이 판단한다. 무엇: 운영 publish 전에 `gclid/gbraid/wbraid`가 랜딩에서 storage와 no-send receiver까지 이어지는지 Preview로만 본다. 왜: 623건 중 5건만 Google click id가 남아 있어 Google Ads confirmed purchase의 1차 병목이다. 어떻게: [[../gdn/paid-click-intent-gtm-preview-approval-20260506]] 기준으로 fresh workspace에서 Preview만 실행한다. 산출물: Preview 결과 캡처와 no-send receiver 응답. 검증: 실제 platform send/write/publish 0건.
