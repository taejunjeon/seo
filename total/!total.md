...
| [[../gdn/paid-click-intent-production-receiver-deploy-approval-20260506|paid_click_intent production receiver 배포 승인안]] | backend 운영 deploy 승인 문서. no-write receiver는 live payload validation만 하며 DB/ledger write는 하지 않음 | pending TJ approval | TJ님 승인/보류 판단. 명시 승인 시 TEST POST 200 후 receiver-enabled GTM publish와 24h/72h 모니터링까지 연속 진행 | deploy 결과 문서 작성 후 close |
