...
Next document: 24h/72h monitoring result 또는 minimal paid_click_intent ledger write 승인안
...
harness_preflight:
  ...
  source_window_freshness_confidence:
    ...
    freshness: "backend receiver route 배포, smoke, GTM receiver-enabled publish, live smoke 통과. 24h/72h monitoring 대기"
    confidence: 0.93
```
...
|---|---|---|---|---|---|
| Phase4 | [[#Phase4-Sprint6]] | paid_click_intent 수집 개선 | TJ + Codex | 90% / 70% | [[#Phase4-Sprint6\|이동]] |
...
|---:|---|---|---|---|---|---|---|---|
| 1 | [[#Phase4-Sprint6]] | publish 완료 / monitoring 대기 | Codex | 24h/72h 모니터링을 시작한다 | live smoke는 통과했지만 실제 고객 트래픽에서 오류율, receiver 2xx, 결제 흐름 이상 여부를 봐야 한다 | GTM live version `142`, receiver 2xx/4xx/5xx, storage evidence, JS error, 외부 전송 0건을 확인한다 | [[#Phase4-Sprint6]] / [[../gdn/paid-click-intent-gtm-production-publish-result-20260506]] | NO, read-only |
...
1. **P0: paid_click_intent Mode B 완료**
   ...
   - 현재: backend no-write receiver route 운영 배포, smoke, GTM publish, live smoke가 통과했다. 24h/72h 모니터링이 남았다.
...
|---|---|---|---|---|---|---|---|---|
| P0 | monitoring | Phase4-Sprint6 | paid_click_intent Mode B | Google click id가 주문까지 사라지는 병목을 줄여야 Google Ads confirmed purchase가 가능하다 | 24h/72h monitoring -> minimal ledger write 판단 | Codex | NO, read-only monitoring | [[../gdn/paid-click-intent-gtm-production-publish-result-20260506]] |
...
| P0 | done_gtm_publish | Phase4-Sprint6 | receiver-enabled GTM publish | 실제 브라우저에서 storage와 receiver까지 이어지는지 확인해야 한다 | 24h/72h monitoring | Codex | 완료 | [[../gdn/paid-click-intent-gtm-production-publish-result-20260506]] |
...
상태: TJ님 조건부 YES. backend receiver route 배포, TEST/negative smoke, receiver-enabled GTM publish, live smoke는 완료. 24h/72h monitoring은 남았다.
